...
def _run_csv(pipeline, args: argparse.Namespace, analyzer=None) -> int:
    ...
    out["was_transliterated"] = [r.was_transliterated for r in results]
    out["cleaned_text"] = [r.cleaned_text for r in results]
    out["transliterated_text"] = [r.transliterated_text for r in results]
    out["translation_backend"] = [r.translation_backend for r in results]
    out["fallback_used"] = [r.fallback_used for r in results]
    out["fallback_reason"] = [r.fallback_reason for r in results]
    out["translation_truncated"] = [r.translation_truncated for r in results]
    out["sentiment_truncated"] = [r.sentiment_truncated for r in results]
    out["low_confidence"] = [r.low_confidence for r in results]
    out["review_recommended"] = [r.review_recommended for r in results]
